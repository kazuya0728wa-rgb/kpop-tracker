...
4. 【除外・絶対に含めない】以下はすべて除外:
   - チケット購入済みの人向けの情報（VIP席アップグレード、座席変更、入場案内等）
   - 特定公演のグッズ情報・POPUP STORE・先行通販（チケットを持っていない人には無関係）
   - サプライズ企画素材募集など来場者向けの案内
   - 雑誌掲載のみ、SNS更新のみ、韓国国内のみの情報
   - ファンクラブ限定の特典・バースデー企画
   → 要するに「まだチケットを買っていないファンが知りたい情報」だけを選ぶこと
